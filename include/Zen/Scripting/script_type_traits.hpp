...
/// Template for determining if a pointer is a shared_ptr<Class_type>
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
/// Specialization for the case that the pointer is shared_ptr<Class_type>
template<typename Class_type>
struct
is_shared_pointer<Class_type, std::shared_ptr<Class_type> >
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
/// Template to remove the shared_ptr<> wrapper of a class
